...
export class ListagemUsuariosTabelaComponent implements OnInit {
  ...
  constructor(private usuarioService: UsuarioService, private roteador: Router, private mensagemConsoleService: IMensagem) {
    ...
    this.usuarioService.apagar(id).subscribe(
      apagado => {
        ...
        if (indx > -1) {
          ...
          this.mensagemConsoleService.alerta('Removido com Sucesso!!!')
        }
      }
    );
  }
